<template>
    <div class="addPicture">
        ...
        <div class="header">
            ...
            <!-- 查询历史页面 -->
            <div v-if="userType == 2" class="headerBtn flowerBth" @click="goToHistory">查询历史</div>
            <!--花型管理按钮-->
            ...
            <div class="uploadBtnArea" v-else>
                <div class="searchArea">
                    ...
                    <div class="uploadBtn"  v-if="!isStartUpload" @click="searchList">点击搜索</div>
                </div>
            </div>
            <!--提示-->
            ...
            <div class="box">
                <div  class="col" ref="col1">
                    <div :class="{item:true,itemLast:(index+1)%4==0}" v-for="(item,index) in mainMenuList" :key="item.id"  v-if="(index+1)%4==1" @mouseover="showDetailId=item.id" @mouseleave="showDetailId=-1">
                        ...
                        <div class="deleteArea" v-if="userType == 2" v-show="item.id==showDetailId" @click="deleteP(item)">删除</div>
                    </div>
                </div>
                <div  class="col" ref="col1">
